...
if (tagPairs.size() > 0) builder.append("{").append(JOINER.join(tagPairs)).append("}"); {if ("" != null) return builder.toString();}
 ...
 {
    if (jj_3R_METRIC_68_25_5()) return true;
    return false;
  }

  private boolean jj_3R_PARAMETER_58_9_3()
 {
    Token xsp;
    xsp = jj_scanpos;
    if (jj_3_2()) {
 ...
 {
    if (jj_3R_EXPRESSION_52_9_4()) return true;
    return false;
  }

  private boolean jj_3R_EXPRESSION_52_9_4()
 {
    if (jj_scan_token(NAME)) return true;
    if (jj_scan_token(7)) return true;
    if (jj_3R_PARAMETER_58_9_3()) return true;
    Token xsp;
    while (true) {
      xsp = jj_scanpos;
  ...
  private boolean jj_3_5()
 {
  ...
  private boolean jj_3R_METRIC_68_25_5()
 {
    if (jj_scan_token(NAME)) return true;
    if (jj_scan_token(10)) return true;
    Token xsp;
