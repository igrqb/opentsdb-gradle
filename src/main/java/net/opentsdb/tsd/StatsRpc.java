...
public final class StatsRpc implements TelnetRpc, HttpRpc {
  ...
  public Deferred<Object> execute(final TSDB tsdb, final Channel chan,
    ...
    final ASCIICollector collector = new ASCIICollector("net/opentsdb/tsd", buf, null);
  ...
  public void execute(final TSDB tsdb, final HttpQuery query) throws BadRequestException, IOException {
    ...
    try {
      ...
      if ("threads".equals(endpoint)) {
        ...
        return;
      } else if ("net/opentsdb/query".equals(endpoint)) {
    ...
    if (query.apiVersion() < 1) {
      ...
      final ASCIICollector collector = new ASCIICollector("net/opentsdb/tsd", buf, stats);
      doCollectStats(tsdb, collector, canonical);
      if (json) {
    ...
    final SerializerCollector collector = new SerializerCollector("net/opentsdb/tsd", dps,
        canonical);
