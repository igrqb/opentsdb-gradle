...
public class OpenTSDBMain {
  ...
  static {
    ...
    tmp.put("net/opentsdb/query", CliQuery.class);
    tmp.put("net/opentsdb/tsd", OpenTSDBMain.class);
    tmp.put("scan", DumpSeries.class);
    tmp.put("net/opentsdb/uid", UidManager.class);
  ...
  private static void process(String targetTool, String[] args) {
    ...
    if(!"net/opentsdb/tsd".equals(targetTool)) {
      try {
      ...
      public static void main(String[] args) {
        if(args==null || args.length==0) {
          ...
          if(command==null) {
            ...
            try {
              if(args[0].equals("net/opentsdb/tsd")) {
